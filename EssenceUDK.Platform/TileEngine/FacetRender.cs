...
namespace EssenceUDK.Platform.TileEngine
{
    public class FacetRender
    {
        ...
        internal class TilesComparer : IComparer<IEntryMapTile>
        {
            ...
            private static readonly ushort[] NodrawLands = { 0x0002, 0x01AF, 0x01B0, 0x01B1, 0x01B2, 0x01B3, 0x01B4, 0x01B5 };
            private static readonly ushort[] NodrawItems = { 0x0001, 0x2198, 0x2199, 0x219A, 0x219B, 0x219C, 0x219D, 0x219E, 
        ...
        private void DrawFacet(int icx, int icy, int bxdw, int bxdh, int bydw, int bydh, byte map, short sealvl, ref ISurface dest, byte range, ushort tx, ushort ty, sbyte minz, sbyte maxz, DrawBlocks drawblocks)
        {
            ...
            //BLOCK X and BLOCKy
            var bx0 = (int)(tx  / 8);//CENTER BLOCK
            var by0 = (int)(ty  / 8);//CENTER BLOCK
            var bx1 = (int)(tx1 / 8);//LOWER BLOCK
            var by1 = (int)(ty1 / 8);//LOWER BLOCK
            var bx2 = (int)(tx2 / 8);//H BLOCK
            var by2 = (int)(ty2 / 8);// H BLOCK
        ...
        private static unsafe void DrawFlatTile(ISurface srs, sbyte z, ushort hue, byte alpha, ref ISurface dst, int cx, int cy)
        {
