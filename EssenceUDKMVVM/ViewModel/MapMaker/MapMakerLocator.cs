...
namespace EssenceUDKMVVM.ViewModel.MapMaker
{
    ...
    public class MapMakerLocator
    {
        ...
        public AreaColorViewModel SelectedAreaColor
        {
            get
            {
                return ServiceLocator.Current.GetInstance<AreaColorViewModel>();
            }
        }
        ...
        public CoastLandViewModel CoastLandTransitionViewModel
        {
            get
            {
                return ServiceLocator.Current.GetInstance<CoastLandViewModel>();
            }
        }
        ...
        public CoastItemsViewModel CoastItemTransitionViewModel
        {
            get
            {
                return ServiceLocator.Current.GetInstance<CoastItemsViewModel>();
            }
        }
        ...
        public CoastsOptionsViewModel CoastOptionsViewModel
        {
            get
            {
                return ServiceLocator.Current.GetInstance<CoastsOptionsViewModel>();
            }
        }
        ...
        public CliffListViewModel CliffListViewModel
        {
            get
            {
                return ServiceLocator.Current.GetInstance<CliffListViewModel>();
            }
        }
