...
namespace EssenceUDKMVVM.ViewModel.MapMaker.Color.Cliff
{
    ...
    public class CliffViewModel : ViewModelDockableBase
    {
        ...
        //NorthSouth = 0,
        public TileContainerViewModel NorthSouth { get { return _list[DirectionCliff.NorthSouth]; } }

        //WestEast = 1,

        public TileContainerViewModel WestEast { get { return _list[DirectionCliff.WestEast]; } }
