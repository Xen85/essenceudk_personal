...
namespace EssenceUDK.UDKMvvM.Plugins.MapMakerPlugin.ViewModels.Textures
{
    ...
    public class AreaTextureViewModel : ViewModelDockableBase
    {
        ...
        {
            CopyTexture =
                new RelayCommand(() => { _clone = (AreaTextures) MapSdk.CloneSdkObject(SelectedAreaTextures); },
