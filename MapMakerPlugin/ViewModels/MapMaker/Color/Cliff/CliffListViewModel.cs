...
using MapMakerPlugin.ViewModels.MapMaker.Color.Cliff.Wrappers;
using Microsoft.Practices.ServiceLocation;

namespace MapMakerPlugin.ViewModels.MapMaker.Color.Cliff
{
    ...
    public class CliffListViewModel : ViewModelDockableBase
    {
        ...
        public CliffListViewModel()
        {
            ...
            RemoveCommand = new RelayCommand(() =>
            {
                foreach (
                    var item in
                        (from DirectionCliff direction in Enum.GetValues(typeof (DirectionCliff))
                            select SelectedItem[direction]).Where(item => item != null))
                {
        ...
        {
            get { return ServiceLocator.Current.GetInstance<AreaColorViewModel>().SelectedAreaColor; }
        }
