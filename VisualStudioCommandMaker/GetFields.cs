...
{
    public class GetFields //: VisualCommanderExt.ICommand
    {
        public void Run(EnvDTE80.DTE2 DTE, Microsoft.VisualStudio.Shell.Package package)
        {
            ...
            {
                text += fieldInfo.FieldType + " " + fieldInfo.Name + ";" + System.Environment.NewLine;
            }
            text = text.Replace("+", ".");
        ...
        {
            IServiceProvider providera = new ServicePRovider(project.DTE as
