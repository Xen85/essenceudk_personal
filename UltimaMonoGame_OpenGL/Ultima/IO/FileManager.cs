...
namespace UltimaXNA.Ultima.IO
{
    class FileManager
    {
        static private bool m_isDataPresent = true;
        ...
        public static  readonly string MFileDirectory = @"C:\ultima\TM2";
        ...
        static FileManager()
        {
            ...
            if (Settings.UltimaOnline.DataDirectory != null && Directory.Exists(Settings.UltimaOnline.DataDirectory))
            {
                ...
                //MFileDirectory = Settings.UltimaOnline.DataDirectory;
            ...
            else
            {
                ...
                Tracer.Debug("Selected: {0}", MFileDirectory);
            }
        }
        ...
        public static string GetFilePath(string name)
        {
            if (MFileDirectory != null)
            {
                name = Path.Combine(MFileDirectory, name);
