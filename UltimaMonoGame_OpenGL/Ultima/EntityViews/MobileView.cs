...
namespace UltimaXNA.Ultima.EntityViews
{
    public class MobileView : AEntityView
    {
        ...
        public override bool Draw(SpriteBatch3D spriteBatch, Vector3 drawPosition, MouseOverList mouseOverList, Map map)
        {
            ...
            int drawCenterX = m_MobileLayers[0].Frame !=null ? m_MobileLayers[0].Frame.Center.X:0;
            int drawCenterY = m_MobileLayers[0].Frame != null ? m_MobileLayers[0].Frame.Center.Y : 0;
