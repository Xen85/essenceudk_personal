...
using EssenceUDK.PluginBase.AttachedProperties;
...
namespace EssenceUDK.PluginBase.ViewModels.DockableModels
{
    ...
    public class AvalonDockLayoutViewModel
    {
        ...
        private InnerRelayCommand _mLoadLayoutCommand;
        private InnerRelayCommand _mSaveLayoutCommand;
        ...
        public ICommand LoadLayoutCommand
        {
            get
            {
                return _mLoadLayoutCommand ?? (_mLoadLayoutCommand = new InnerRelayCommand(p =>
                {
